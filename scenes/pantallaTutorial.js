export default class PantallaTutorial extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(400, 100, 'Aprende a jugar:', { fontSize: '20px', color: '#fff', fontFamily: 'Pixellaria' }).setOrigin(0.5);
    // Imagen WASD 
    this.add.image(400, 220, 'WASD').setDisplaySize(140, 140).setOrigin(0.5);
    // Indicaciones de controles
    this.add.text(380, 155, 'SALTAR', { fontSize: '18px', color: '#fff', fontFamily: 'Pixellaria' }).setOrigin(0.5);
    this.add.text(420, 280, 'AGACHARSE', { fontSize: '18px', color: '#fff', fontFamily: 'Pixellaria' }).setOrigin(0.5);
    this.add.text(280, 230, 'IZQUIERDA', { fontSize: '18px', color: '#fff', fontFamily: 'Pixellaria' }).setOrigin(0.5);
    this.add.text(520, 230, 'DERECHA', { fontSize: '18px', color: '#fff', fontFamily: 'Pixellaria' }).setOrigin(0.5);
    const volver = this.add.text(70, 30, 'VOLVER', { fontSize: '20px', color: '#ff0', fontFamily: 'Pixellaria' }).setOrigin(0.5);
