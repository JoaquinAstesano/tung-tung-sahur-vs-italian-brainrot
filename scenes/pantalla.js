export default class PantallaMenu extends Phaser.Scene {
  ...
  create() {
    ...
    this.jugarText = this.add.text(400, 150, 'JUGAR', { fontSize: '36px', color: '#ff0', fontFamily: 'Pixellari' }).setOrigin(0.5);
    this.opcionesText = this.add.text(400, 200, 'OPCIONES', { fontSize: '20px', color: '#fff', fontFamily: 'Pixellari' }).setOrigin(0.5);
    this.creditosText = this.add.text(400, 235, 'CRÉDITOS', { fontSize: '20px', color: '#fff', fontFamily: 'Pixellari' }).setOrigin(0.5);
